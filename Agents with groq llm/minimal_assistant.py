...
FLASK_SERVER_URL = " https://6582-2409-40f4-37-a39d-280b-1fec-9391-4a45.ngrok-free.app/validate_audio"
...
async def entrypoint(ctx: JobContext):
    ...
    agent = VoicePipelineAgent(
        ...
        llm=groq_llm, #groq implementation
        tts=cartesia.TTS(), #cartesia implementation
    ...
    await agent.say("Hey, hi! How can I assist you today?", allow_interruptions=True)
